...
def run():
    grade_map = read_grade_mapping_from_excel('关键词规则.xls', 0)
    subject_map = read_grade_mapping_from_excel('关键词规则.xls', 1)
    class_map = read_class_mapping_from_excel('关键词规则.xls', 2)
